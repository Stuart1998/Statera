define(['shared/gw_common'], function(GW) {
    return {
        ...
        describe: function(params) { 
            return "Improved Fabricator Build Arms increase the build speed of all fabricator and factory build arms by 50% and reduces energy usage by 50%.";
        },
        summarize: function(params) {
            return 'Improved Fabricator Build Arms';
        },
