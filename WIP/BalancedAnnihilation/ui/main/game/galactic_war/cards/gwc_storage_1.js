define(['shared/gw_common'], function(GW) {
    return {
        ...
        describe: function(params) { 
            return 'Doubles the metal and energy storage on all commanders and storage structures. Adds in blueprints for storage structures.';
        },
        summarize: function(params) {
            return 'Storage Compression Tech';
        },
