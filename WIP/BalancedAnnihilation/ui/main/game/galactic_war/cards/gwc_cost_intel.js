define(['shared/gw_common'], function(GW) {
    return {
        ...
        describe: function(params) { 
            return 'Intelligence Fabrication Tech reduces metal build costs of all intelligence structures and mobile units by 50%';
        },
        summarize: function(params) {
            return 'Intelligence Fabrication Tech';
        },
