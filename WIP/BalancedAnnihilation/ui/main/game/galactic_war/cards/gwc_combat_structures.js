define(['shared/gw_common'], function(GW) {
    return {
        ...
        describe: function(params) { 
            return 'Structure Combat Tech increases the health of all structures by 50%. Defensive structures also gain a 25% damage increase.';
        },
        summarize: function(params) {
            return 'Structure Combat Tech';
        },
        ...
        buff: function (inventory, params) {
            ...
            var ammos = [
				...
				'/pa/units/land/rocket_defense/rocket_defense_ammo.json',
				'/pa/units/land/laser_defense_sniper/laser_defense_sniper.json',
