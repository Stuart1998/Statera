    ...
    self.SpecIdToGridMap = ko.observable(
        {
            ...
            "/pa/units/land/tactical_missile_launcher/tactical_missile_launcher.json": ["combat", 1],
            "/pa/units/land/laser_defense/laser_defense.json": ["combat", 2],
            "/pa/units/land/air_defense_adv/air_defense_adv.json": ["combat", 5],       
            "/pa/units/land/artillery_long/artillery_long.json": ["combat", 6],
            "/pa/units/sea/torpedo_launcher_adv/torpedo_launcher_adv.json": ["combat", 7],
            "/pa/units/land/nuke_launcher/nuke_launcher.json": ["combat", 8],
			"/pa/units/land/precision_launcher/precision_launcher.json": ["combat", 9],
            ...
            "/pa/units/land/tank_heavy_armor/tank_heavy_armor.json": ["vehicle", 6],
            "/pa/units/land/tank_heavy_mortar/tank_heavy_mortar.json": ["vehicle", 7],
			"/pa/units/land/tank_amphibious_adv/tank_amphibious_adv.json",: ["vehicle", 8],
<<<<<<< HEAD
<<<<<<< HEAD
            "/pa/units/land/fabrication_vehicle/fabrication_vehicle.json": ["vehicle", 9],
            "/pa/units/land/fabrication_vehicle/.json": ["vehicle", 10],            "/pa/units/land/tank_light_laser/tank_light_laser.json": ["vehicle", 11],
=======
...
>>>>>>> parent of bf63dff... Fixed the derpery.
=======
            "/pa/units/land/fabrication_vehicle/fabrication_vehicle.json": ["vehicle", 10],
            "/pa/units/land/tank_hover/tank_hover.json": ["vehicle", 9],            "/pa/units/land/tank_light_laser/tank_light_laser.json": ["vehicle", 11],
>>>>>>> parent of b62eefa... Fixed more derpery.
            ...
            "/pa/units/land/tank_hover/tank_hover.json": ["vehicle", 9],
        			
            "/pa/units/land/fabrication_bot_adv/fabrication_bot_adv.json": ["bot", 0],   
            "/pa/units/land/assault_bot_adv/assault_bot_adv.json": ["bot", 3],
            "/pa/units/land/bot_grenadier/bot_grenadier.json": ["bot", 4],
			...
			"/pa/units/land/megabot/megabot.json": ["bot", 7],
            "/pa/units/land/bot_bomb/bot_bomb.json": ["bot", 8],
            "/pa/units/land/fabrication_bot/fabrication_bot.json": ["bot", 9],     
            "/pa/units/land/assault_bot/assault_bot.json": ["bot", 10],
            "/pa/units/land/amphibious_bot/amphibious_bot.json": ["bot", 11],
            ...
            "/pa/units/air/bomber/bomber.json": ["air", 13],
